...
(function () {
  ...
  const SPECIES = [
    { id: 1, vernacular: 'Common Kingfisher',     latin: 'Alcedo atthis',          shape: 'L',
      band_a: '#3d6b8a', band_b: '#4a7c9a',
      image: F('Birds_9 (1 van 12)_Com.webp') },
    { id: 2, vernacular: 'Eurasian Hoopoe',       latin: 'Upupa epops',            shape: 'V',
      band_a: '#c79e6e', band_b: '#b88c5e',
      image: F('Birds_9 (1 van 1)-8_Com.webp') },
    { id: 3, vernacular: 'Great Crested Grebe',   latin: 'Podiceps cristatus',     shape: 'L',
      band_a: '#7a8b76', band_b: '#8a9c86',
      image: F('Birds_9 (6 van 12)_Com.webp') },
    { id: 4, vernacular: 'Northern Lapwing',      latin: 'Vanellus vanellus',      shape: 'W',
      band_a: '#3a4a3e', band_b: '#48584c',
      image: F('Birds_9 (1 van 1)-4_Com.webp') },
    { id: 5, vernacular: 'European Bee-eater',    latin: 'Merops apiaster',        shape: 'L',
      band_a: '#a87a3e', band_b: '#b8893f',
      image: F('Birds (3 van 8)_Com.webp') },
    { id: 6, vernacular: 'Eurasian Bittern',      latin: 'Botaurus stellaris',     shape: 'V',
      band_a: '#8b7848', band_b: '#9a8758',
      image: F('Birds_9 (1 van 1)-9_Com.webp') },
    { id: 7, vernacular: 'Bohemian Waxwing',      latin: 'Bombycilla garrulus',    shape: 'L',
      band_a: '#6e5444', band_b: '#7e6454',
      image: F('Birds_9 (8 van 12)_Com.webp') },
    { id: 8, vernacular: 'Little Egret',          latin: 'Egretta garzetta',       shape: 'W',
      band_a: '#cdc4b0', band_b: '#bdb4a0',
      image: F('Birds_9 (1 van 1)-2_Com.webp') },
  ];
